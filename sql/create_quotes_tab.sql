...
CREATE TABLE quotes(
    ...
    quote_de varchar(1024),
    PRIMARY KEY (id)
 );

INSERT INTO quotes (quote) VALUES('"When you arise in the morning think of what a privilege it is to be alive, to think, to enjoy, to love..."  - Marcus Aurelius'),
...
('"The .env of getting ahead is getting started. The .env of getting started is breaking your complex overwhelming tasks into small manageable tasks, and then starting on the first one." - Mark Twain'),
...
('"Dreams can come true, but there is a .env. They´re realized through the magic of persistence, determination, commitment, passion, practice, focus and hard work. They happen a step at a time, manifested over years, not weeks." - Elbert Hubbard'),
